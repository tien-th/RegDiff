...
# python3 main.py --config configs/25_03_Ldm_reg.yaml --train --sample_at_start --save_top --gpu_ids 2
#  --resume_model ./results/LDM_reg_smooth_03_0.15/LDM-f4/checkpoint/latest_model_126.pth --resume_optim ./results/LDM_reg_smooth_03_0.15/LDM-f4/checkpoint/latest_optim_sche_126.pth

#test
python3 main.py --config configs/25_03_Ldm_reg.yaml --sample_to_eval --gpu_ids 1 --resume_model ./results/LDM_reg_smooth_03_0.15/LDM-f4/checkpoint/top_model_epoch_132.pth --resume_optim ./results/LDM_reg_smooth_03_0.15/LDM-f4/checkpoint/top_optim_sche_epoch_132.pth
