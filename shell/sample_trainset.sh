...
#test
CUDA_VISIBLE_DEVICES=1,2 python3 main.py --config configs/sample_trainset.yaml --sample_to_eval --gpu_ids 1 --resume_model ckpt/top_model_epoch_124.pth  --resume_optim ckpt/top_optim_sche_epoch_124.pth
